...
namespace BethanyPieShop.Migrations
{
    ...
    [Migration("20191216041220_BethanyAzure")]
    partial class BethanyAzure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanyPieShop.Model.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShop.Model.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShop.Model.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShop.Model.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanyPieShop.Model.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanyPieShop.Model.OrderDetail", b =>
                {
                    b.HasOne("BethanyPieShop.Model.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanyPieShop.Model.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanyPieShop.Model.Pie", b =>
                {
                    b.HasOne("BethanyPieShop.Model.Category", "Category")
                        .WithMany("Pies")
